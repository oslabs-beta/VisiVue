...
.basicflow .vue-flow__node:hover {
  ...
  box-shadow: rgba(66, 211, 146, .3) 0px 1px 2px, rgba(66, 211, 146, .2) 0px 2px 4px,
  rgba(66, 211, 146, .3) 0px 4px 8px, rgba(66, 211, 146, .3) 0px 8px 16px, rgba(100, 126, 255, .8) 0px 8px 18px;
